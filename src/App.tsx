...
const DoctorWallet = lazy(
  () => import("./pages/Doctor/Wallet"),
);

// فرم‌ها
const AnamnesisForm = lazy(
  () => import("./pages/AnamnesisForm"),
);
